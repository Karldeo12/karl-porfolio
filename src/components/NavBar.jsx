        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link href="#projects" className={activeLink === 'projects' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('projects')}>My Projects and My Dreams</Nav.Link>
            ...
            <span className="navbar-text">
              ...
              <HashLink to='#connect'>
                <button className="vvd" ><span>Let’s get in Contact  </span><ArrowRightCircle size={25} /></button>
              </HashLink>
            </span>
          </Navbar.Collapse>
        </Container>
